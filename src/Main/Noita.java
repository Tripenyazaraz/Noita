            ...
            public void run() {
                if (isPressed)
                    if ((mouseX >= 0) & (mouseY >= 0) &
                        ...
                        switch (whichButton) {
                            case ("PRIMARY") -> toPaste = choosenParticle;
